...
public class Level_1Controller extends setUp implements Initializable {
     ...
     */
    @FXML
    private void moveControl(KeyEvent event) {
    ...
    public void nextLevel(Event event) throws IOException {
        changeScene(event, "level_2.fxml");
    }
